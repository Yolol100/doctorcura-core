...
// these symbols. Skip duplicate modules to avoid activation-time fatals.
...
// Only the copy that loaded the Plugin class owns lifecycle hooks. If an
// older Core copy is already active, add only the new privacy layer.
